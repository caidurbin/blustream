...
Live-hardware also revealed an undocumented `_ssh._tcp` service on
port 22 — outside the design scope for identity but flagged for
separate security/feature follow-up.
