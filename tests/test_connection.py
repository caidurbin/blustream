...
class TestTCPConnection:
    ...
    async def test_connect_success(self, mock_open_connection):
        ...
        mock_reader.read = AsyncMock(side_effect=["welcome", asyncio.TimeoutError()])
    ...
    async def test_send_receive(self, mock_open_connection):
        ...
        mock_reader.read = AsyncMock(side_effect=["welcome", asyncio.TimeoutError(), "response", asyncio.TimeoutError()])
    ...
    async def test_receive_timeout(self, mock_open_connection):
        ...
        mock_reader.read = AsyncMock(side_effect=["welcome", asyncio.TimeoutError(), asyncio.TimeoutError()])
        mock_open_connection.return_value = (mock_reader, mock_writer)
    ...
    async def test_receive_partial_data(self, mock_open_connection):
        ...
        mock_reader.read = AsyncMock(side_effect=["welcome", asyncio.TimeoutError(), "partial", asyncio.TimeoutError()])
        mock_open_connection.return_value = (mock_reader, mock_writer)
