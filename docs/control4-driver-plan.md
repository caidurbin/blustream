...
**Author:** Cai Durbin (`cai.durbin@gmail.com`)
...
- **Default credentials (factory):** username `blustream`, password `@Bls1234`. First admin login is forced to set a new password.
- **SSH (port 22):** dropbear runs on the device. Not a documented management interface; the driver does not use it.
